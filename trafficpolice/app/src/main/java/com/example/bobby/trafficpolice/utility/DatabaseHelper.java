package com.example.bobby.trafficpolice.utility;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    public static final String Database_Name="trafficpolice.db";
    public static final String Table_Name="trafficpolicesignin_table";
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("Create table trafficpolicesignin_table(ID INTEGER PRIMARY KEY AUTOINCREMENT,username TEXT,password TEXT,logout Text)");
    }
