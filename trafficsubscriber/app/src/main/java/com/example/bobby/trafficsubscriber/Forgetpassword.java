...
public class Forgetpassword extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(Forgetpassword.this, "Check your input", Toast.LENGTH_SHORT).show();
                }
    ...
    class JSONP extends AsyncTask<Void,Void,String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            jsonurl ="http://bjprogrammer.co.nf/nigeriantraffic/forgetpassword.php";
        ...
        protected void onPostExecute(String s) {
            ...
            if(s.contains("successfully") && s.contains("email"))
            {
            ...
            else if(s.contains("successfully") && s.contains("mobile"))
            {
                e1.setVisibility(EditText.GONE);
                b1.setVisibility(Button.GONE);
                t1.setVisibility(TextView.GONE);
                ...
                Toast.makeText(Forgetpassword.this, "OTP sent successfully to your registered mobile no.", Toast.LENGTH_SHORT).show();
            }
            else
            {
                e1.setText("");
    ...
    class JSONP2 extends AsyncTask<Void,Void,String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            jsonurl ="http://bjprogrammer.co.nf/nigeriantraffic/forgetpassword2.php";
        ...
        protected void onPostExecute(String s) {
            ...
            {
                Toast.makeText(Forgetpassword.this, "Password reset successful.Please sign in again using your new login credentials", Toast.LENGTH_SHORT).show();
