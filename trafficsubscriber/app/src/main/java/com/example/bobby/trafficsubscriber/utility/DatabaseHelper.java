...
public class DatabaseHelper extends SQLiteOpenHelper {
    public static final String Database_Name="trafficsubscribersignin.db";
    public static final String Table_Name="trafficsubscribersignin_table";
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("Create table trafficsubscribersignin_table(ID INTEGER PRIMARY KEY AUTOINCREMENT,username TEXT,password TEXT,logout Text)");
    }
